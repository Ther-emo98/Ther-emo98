...
//        获取注册人脸的用户id
         faceid = intent.getIntExtra("faceid",0);
        url =intent.getStringExtra("url");
        userName =intent.getStringExtra("userName");
        Log.i(TAG, "onCreate: 传递的参数:"+faceid);
...
//        SingleBaseConfig.getBaseConfig().setNirDetectDirection(180);
        ...
        Log.i("是否Rgb", "initView: "+SingleBaseConfig.getBaseConfig().getRgbRevert());
        Log.i(TAG, "initView: 进入反转");
//        mDrawDetectFaceView.setRotationY(180);
        mEditName.setText(String.valueOf(faceid));
...
//    更新用户是否录入人脸状态
    public void UpdateIsFace() throws JSONException {
        //      实例化OkHttpClient
        ...
        jsonObject.put("userId", faceid);
        jsonObject.put("isRegisterFace", "已注册人脸");
        ...
        //      构建request请求
         final Request request = new Request.Builder()
                ...
                .build();
        Log.i("headers", "UpdateIsFace: "+request.headers());
                            ...
                            public void run() {
                                try {
                                    ...
                                    if(code==200){
                                        ...
                                        Toast.makeText(FaceRegisterNewActivity.this, "后台更新用户失败", Toast.LENGTH_SHORT).show();
                                    }
                                } catch (JSONException e) {
                                    throw new RuntimeException(e);
                                }

...
public class StartActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.baidu.idl.main.facesdk.registerlibrary.user.model.SingleBaseConfig.getBaseConfig().setRgbVideoDirection(180);
        com.baidu.idl.main.facesdk.registerlibrary.user.model.SingleBaseConfig.getBaseConfig().setNirVideoDirection(180);
        com.baidu.idl.main.facesdk.registerlibrary.user.model.SingleBaseConfig.getBaseConfig().setRgbDetectDirection(180);
        com.baidu.idl.main.facesdk.registerlibrary.user.model.SingleBaseConfig.getBaseConfig().setNirDetectDirection(180);
        SingleBaseConfig.getBaseConfig().setRgbVideoDirection(180);
        SingleBaseConfig.getBaseConfig().setNirVideoDirection(180);
        SingleBaseConfig.getBaseConfig().setRgbDetectDirection(180);
        SingleBaseConfig.getBaseConfig().setNirDetectDirection(180);
...
//        设置接口地址
        ...
        //步骤3：将获取过来的值放入文件
        editor.putString("apiUrl",requests.ApiUrl);
        //步骤4：提交

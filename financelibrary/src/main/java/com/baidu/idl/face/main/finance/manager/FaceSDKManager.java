    ...
    public boolean onQualityCheck(final LivenessModel livenessModel,
        ...
        if (livenessModel != null && livenessModel.getFaceInfo() != null) {
            ...
            if (Math.abs(livenessModel.getFaceInfo().yaw) > SingleBaseConfig.getBaseConfig().getGesture() ||
                    Math.abs(livenessModel.getFaceInfo().roll) > SingleBaseConfig.getBaseConfig().getGesture() ||
                    Math.abs(livenessModel.getFaceInfo().pitch) > SingleBaseConfig.getBaseConfig().getGesture()) {
